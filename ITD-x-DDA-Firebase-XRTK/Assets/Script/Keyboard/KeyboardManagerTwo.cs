...
public class KeyboardManagerTwo : MonoBehaviour
{
    ...
    {
        ResEmail.text = ResEmail.text.Remove(ResEmail.text.Length - 1, 1);
        //ResEmail.GetComponentInChildren<TMP_InputField>().text = ResEmail.GetComponentInChildren<TMP_InputField>().text.Remove(ResEmail.GetComponentInChildren<TMP_InputField>().text.Length - 1, 1);
    }
